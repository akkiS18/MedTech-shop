	...
	return (
		<div>
			<section className="text-gray-600 body-font">
				<div className="container px-5 py-36 mx-auto">
					<div className="flex flex-col text-center w-full mb-20">
						<h1 className="sm:text-3xl text-2xl font-bold title-font text-blue-950">
							KONTAKTLAR
						</h1>
					</div>
			...
			<section className="text-gray-600 body-font relative">
				<h1 className="text-3xl text-center font-bold text-blue-900 uppercase">
					Bizning manzilimiz
				</h1>
				<div className="container px-5 py-12 mx-auto lg:flex">
					...
					<div className="lg:w-1/2 max-lg:hidden bg-gray-300 rounded-lg overflow-hidden p-10 flex items-end justify-start relative">
						<iframe
							width="100%"
							height="100%"
							className="chart absolute inset-0"
							title="map"
							src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d191884.839870258!2d69.11455388143587!3d41.2827379466668!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x38ae8b0cc379e9c3%3A0xa5a9323b4aa5cb98!2z0KLQsNGI0LrQtdC90YIsINCj0LfQsdC10LrQuNGB0YLQsNC9!5e0!3m2!1sru!2s!4v1711438654632!5m2!1sru!2s"></iframe>
					</div>
				</div>
			</section>
		</div>
