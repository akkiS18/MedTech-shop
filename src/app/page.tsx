						...
						<div className="p-8 lg:w-1/4 w-full">
							<div className="shadow-xl hover:bg-gray-100 border px-4 py-6 rounded-lg">
								<svg
									...
									stroke-width="1.5"
									stroke="currentColor"
									className="text-orange-400 w-12 h-12 mb-3 inline-block">
									<path
								...
								<h2 className="title-font font-medium text-md text-blue-900">
									Yuqori sifat
								</h2>
								<p className="leading-relaxed text-xs lg:hidden">
									Sifat narx/pul uchun eng yaxshi qiymatga teng
								</p>
							</div>
						</div>
						<div className="p-8 lg:w-1/4 w-full">
							<div className="shadow-xl hover:bg-gray-100 border px-4 py-6 rounded-lg">
								...
								<p className="leading-relaxed text-xs lg:hidden">
									Oyiga 300 dan ortiq yotoq ishlab chiqarish quvvati
								</p>
							</div>
						</div>
						<div className="p-8 lg:w-1/4 w-full">
							<div className="shadow-xl hover:bg-gray-100 border px-4 py-6 rounded-lg">
								...
								<p className="leading-relaxed text-xs lg:hidden">
									Sotishdan oldingi va sotishdan keyingi mukammal xizmat
								</p>
							</div>
						</div>
						<div className="p-8 lg:w-1/4 w-full">
							<div className="shadow-xl hover:bg-gray-100 border px-4 py-6 rounded-lg">
								...
								<p className="leading-relaxed text-xs lg:hidden">
									Har doim zaxirada: 500 dan ortiq tibbiy yotoqlar
								</p>
							</div>
						</div>
					</div>
			...
			<section className="py-12">
				...
				<div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
					<div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
						<Link
							href={"/catalog"}
							className="w-full mb-8 text-2xl font-bold text-blue-900 hover:text-orange-400 border-b border-b-gray-400">
			...
			<section className="max-xl:hidden">
				<div className="main-container mt-24">
					<div className="company-box flex justify-between">
						<Link
							href={"/"}
							className="w-1/2 flex title-font font-bold items-center text-gray-900 py-24 px-5">
							<svg
								xmlns="http://www.w3.org/2000/svg"
								fill="none"
								viewBox="0 0 24 24"
							...
							<span className="ml-3 text-8xl text-orange-500">MedTech</span>
						</Link>
				...
				<div className="flex md:flex-row flex-col items-center">
					<div className="lg:flex-grow md:w-1/3 flex px-12 flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
						...
						<div className="flex justify-center pb-12">
							...
							<a
								href="tel:+998440252525"
								className="ml-4 inline-flex text-white bg-orange-400 border-0 py-2 px-6 focus:outline-none hover:bg-orange-500 rounded text-lg">
								Telefon
							</a>
						</div>
					</div>
