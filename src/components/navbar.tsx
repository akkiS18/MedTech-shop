	...
	return (
		<header className="text-gray-600 body-font lg:bg-white bg-blue-900 shadow-xl fixed z-50 w-full top-0">
			<div className="lg:container mx-auto flex p-5 flex-row ">
				<Link
					href={"/"}
					className="flex title-font font-bold items-center text-white lg:text-gray-900 mb-0 px-4">
					<svg
					...
					<span className="ml-3 text-4xl text-orange-500">MedTech</span>
				</Link>
				<nav className="mr-auto md:ml-4 md:py-1 md:pl-4 flex flex-wrap items-center text-base justify-center">
					<Link
						href={"/about"}
						className="max-lg:hidden link font-semibold text-blue-950 mr-5 hover:text-orange-400 text-lg">
						Biz haqimizda
						<div className="bar">
				...
				<Link
					href={"/catalog"}
					className="max-lg:hidden header-top__action-btn">
					<svg
						width="25"
						height="25"
						viewBox="0 0 16 17"
						...
						xmlns="http://www.w3.org/2000/svg">
						<path
							d="M7.25 13C10.1495 13 12.5 10.6495 12.5 7.75C12.5 4.85051 10.1495 2.5 7.25 2.5C4.35051 2.5 2 4.85051 2 7.75C2 10.6495 4.35051 13 7.25 13Z"
							stroke="#828282"
							stroke-linecap="round"
							stroke-linejoin="round"></path>
						<path
							d="M10.9625 11.4625L14 14.5"
							stroke="#828282"
							stroke-linecap="round"
							stroke-linejoin="round"></path>
					</svg>
				...
				<button className="max-lg:hidden text-blue-950 hover:text-orange-400 font-semibold py-0 px-4">
					UZ
				</button>
			...
			{isOpen && (
				<nav className="flex z-50 bg-blue-900 text-white lg:hidden px-6 py-4">
					<ul className="w-1/2">
						<li className="w-36 py-2 hover:text-orange-400 cursor-pointer">
					...
					<div className="w-1/2 flex flex-row justify-end items-center">
						...
						<button className="text-white hover:text-orange-400 font-semibold py-0 px-4">
							UZ
						</button>
					</div>
				</nav>
